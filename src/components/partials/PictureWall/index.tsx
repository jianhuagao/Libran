...
export default function PictureWall() {
  return (
    <div className="hiddenScrollbar flex items-center gap-12 overflow-scroll py-20">
      {[1, 2, 3, 4, 5, 6, 7, 8].map(item => (
        <div key={item} className="rotate-4 hover:rotate-0 hover:scale-105 transition-transform">
