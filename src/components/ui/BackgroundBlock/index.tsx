export default function BackgroundBlock() {
  ...
  return (
    ...
    <div className="pointer-events-none absolute inset-0 -z-20 bg-green-100 bg-[url(/img/wallpaper/w2.jpg)] [mask-image:linear-gradient(180deg,white_1%,rgba(255,255,255,0)_98%)] bg-cover bg-center bg-no-repeat dark:bg-green-800 dark:bg-[url(/img/wallpaper/w1.jpg)]"></div>
  );
}
